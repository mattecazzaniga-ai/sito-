          ...
          {whyParticipate.benefits.map((benefit, index) => {
            ...
            return (
              <Reveal key={benefit.title} delay={index * 0.05}>
                <div className="group flex h-full flex-col gap-4 rounded-3xl border border-neutral-200 p-7 transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-green/30 hover:shadow-[0_24px_48px_-24px_rgba(0,0,0,0.18)]">
                  <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-green/10 text-green transition-colors duration-300 group-hover:bg-green group-hover:text-white">
